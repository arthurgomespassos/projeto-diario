...
/***/ "./frontend/modules/UserValidation.js":
/*!********************************************!*\
  !*** ./frontend/modules/UserValidation.js ***!
  \********************************************/
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function (formClassName) {
  var form = document.querySelector(formClassName);
  addValidateListenersInForm(form);
});

var addValidateListenersInForm = function addValidateListenersInForm(form) {
...
var haveInputErrorMessage = function haveInputErrorMessage() {
  return document.querySelector('.invalid-input');
};

var removeInputErrorMessage = function removeInputErrorMessage(el) {
  var message = el.parentElement.querySelector('.invalid-input');
  if (!message) return;
  message.remove();
};

var addInputErrorMessage = function addInputErrorMessage(el, msg) {
...
var validateName = function validateName(el) {
  var valid = /^(?=.{3,20}$)(?![\W])(?!\W)[\w]+(?<![\W])$/.test(el.value);
...
var validateEmail = function validateEmail(el) {
  addInputErrorMessage(el, 'Email Inválido!');
  var valid = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/.test(el.value);
...
var validatePassword = function validatePassword(el) {
  var valid = /^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9]).{8,20}$/.test(el.value);

  if (valid) {
    removeInputErrorMessage(el);
  } else {
    addInputErrorMessage(el, "Senha deve conter de 8 a 20 caracteres\n    Senha deve conter letras mai\xFAsculas e min\xFAsculas e n\xFAmeros");
  }
...
var chooseValidator = function chooseValidator(el) {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n  --white: #FFFFFF;\n  --gray: #EBEBEB;\n  --dark-gray: #BBBBBB;\n  --dark: #161b22;\n  --darker: #0D1117;\n  --blue: #32ADFF;\n  --wellow: #f0ff6c;\n  --red: #ED254E;\n  --green: #5bcf2d;\n  --nav-height: 5.5rem;\n}\n\n* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n  transition: background-color ease-out 120ms;\n}\n\nhtml {\n  font-size: 62.5%;\n}\n\nbody {\n  font-size: 1.6rem;\n  font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n  background-color: var(--white);\n  height: 100vh;\n}\n\nbody {\n  display: grid;\n  grid-template-rows: calc(var(--nav-height) + 1rem) 1fr;\n}\n\n.nav-container {\n  grid-row: 1 / 2;\n}\n\n.form-container {\n  grid-row: 2 / 3;\n}\n\n\n.nav-container {\n  position: fixed;\n  top: 0;\n  right: 0;\n  left: 0;\n  background-color: var(--gray);\n  height: var(--nav-height);\n  padding: 0 2rem;\n  box-shadow: 0 0.1rem 0 0 var(--dark-gray);\n}\n\n.nav-content {\n  display: grid;\n  grid-template-columns: 1fr 5fr;\n  min-height: 100%;\n\n}\n\n.nav-content li {\n  background-color: var(--gray);\n  list-style: none;\n  display: flex;\n  align-items: center;\n}\n\n.nav-content a {\n  color: var(--darker);\n  text-decoration: none;\n  font-size: 2rem;\n  font-weight: bold;\n  padding: calc((var(--nav-height) - 2.3rem) /2);\n}\n\n.nav-content a:hover {\n  background-color: var(--dark-gray);\n}\n\n.nav-content .left,\n.nav-content .right {\n  height: var(--nav-height);\n  display: flex;\n  align-items: stretch;\n  justify-content: center;\n}\n\n.nav-content .left {\n  grid-column: 1 / 2;\n  display: flex;\n  justify-content: left;\n}\n\n.nav-content .right {\n  grid-column: 2 / 3;\n  display: flex;\n  justify-content: right;\n}\n\n.form-container {\n  border: none;\n  /* height: 100%; */\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.form-content {\n  width: 50vw;\n  max-width: 30rem;\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: center;\n  padding: 1rem;\n  gap: 1.5rem;\n  border: 0.2rem solid var(--blue);\n  border-radius: 1rem;\n  box-shadow: 0 0 0.5rem 0.05rem var(--darker);\n}\n\n\n\n.form-item {\n  display: block;\n  width: 100%;\n}\n\n.form-item label {\n  display: block;\n  padding-bottom: 0.5rem;\n}\n\n.form-item input,\n.form-item button {\n  width: 100%;\n  height: 3rem;\n  text-align: center;\n}\n\n.form-item input {\n  border: 0.1rem solid var(--gray);\n}\n\n.form-item input:hover {\n  border: 0.1rem solid var(--dark);\n}\n\n.form-item input:focus {\n  border: 0.rem solid var(--darker);\n}\n\n.form-item button {\n  background-color: var(--blue);\n  border: none;\n  border-radius: 0.5rem;\n  font-weight: 500;\n  font-size: 1.8rem;\n\n}\n\n.form-item button:hover {\n  background-color: var(--green);\n}\n\n.invalid-input {\n  color: var(--darker);\n  background-color: var(--red);\n  border-radius: 0 0 0.8rem 0.8rem;\n  font-size: 1.2rem;\n  padding: 0.5rem;\n  text-align: center;\n}", "",{"version":3,"sources":["webpack://./frontend/assets/css/style.css"],"names":[],"mappings":"AAAA;EACE,gBAAgB;EAChB,eAAe;EACf,oBAAoB;EACpB,eAAe;EACf,iBAAiB;EACjB,eAAe;EACf,iBAAiB;EACjB,cAAc;EACd,gBAAgB;EAChB,oBAAoB;AACtB;;AAEA;EACE,SAAS;EACT,UAAU;EACV,sBAAsB;EACtB,2CAA2C;AAC7C;;AAEA;EACE,gBAAgB;AAClB;;AAEA;EACE,iBAAiB;EACjB,wIAAwI;EACxI,8BAA8B;EAC9B,aAAa;AACf;;AAEA;EACE,aAAa;EACb,sDAAsD;AACxD;;AAEA;EACE,eAAe;AACjB;;AAEA;EACE,eAAe;AACjB;;;AAGA;EACE,eAAe;EACf,MAAM;EACN,QAAQ;EACR,OAAO;EACP,6BAA6B;EAC7B,yBAAyB;EACzB,eAAe;EACf,yCAAyC;AAC3C;;AAEA;EACE,aAAa;EACb,8BAA8B;EAC9B,gBAAgB;;AAElB;;AAEA;EACE,6BAA6B;EAC7B,gBAAgB;EAChB,aAAa;EACb,mBAAmB;AACrB;;AAEA;EACE,oBAAoB;EACpB,qBAAqB;EACrB,eAAe;EACf,iBAAiB;EACjB,8CAA8C;AAChD;;AAEA;EACE,kCAAkC;AACpC;;AAEA;;EAEE,yBAAyB;EACzB,aAAa;EACb,oBAAoB;EACpB,uBAAuB;AACzB;;AAEA;EACE,kBAAkB;EAClB,aAAa;EACb,qBAAqB;AACvB;;AAEA;EACE,kBAAkB;EAClB,aAAa;EACb,sBAAsB;AACxB;;AAEA;EACE,YAAY;EACZ,kBAAkB;EAClB,aAAa;EACb,uBAAuB;EACvB,mBAAmB;AACrB;;AAEA;EACE,WAAW;EACX,gBAAgB;EAChB,aAAa;EACb,eAAe;EACf,uBAAuB;EACvB,aAAa;EACb,WAAW;EACX,gCAAgC;EAChC,mBAAmB;EACnB,4CAA4C;AAC9C;;;;AAIA;EACE,cAAc;EACd,WAAW;AACb;;AAEA;EACE,cAAc;EACd,sBAAsB;AACxB;;AAEA;;EAEE,WAAW;EACX,YAAY;EACZ,kBAAkB;AACpB;;AAEA;EACE,gCAAgC;AAClC;;AAEA;EACE,gCAAgC;AAClC;;AAEA;EACE,iCAAiC;AACnC;;AAEA;EACE,6BAA6B;EAC7B,YAAY;EACZ,qBAAqB;EACrB,gBAAgB;EAChB,iBAAiB;;AAEnB;;AAEA;EACE,8BAA8B;AAChC;;AAEA;EACE,oBAAoB;EACpB,4BAA4B;EAC5B,gCAAgC;EAChC,iBAAiB;EACjB,eAAe;EACf,kBAAkB;AACpB","sourcesContent":[":root {\n  --white: #FFFFFF;\n  --gray: #EBEBEB;\n  --dark-gray: #BBBBBB;\n  --dark: #161b22;\n  --darker: #0D1117;\n  --blue: #32ADFF;\n  --wellow: #f0ff6c;\n  --red: #ED254E;\n  --green: #5bcf2d;\n  --nav-height: 5.5rem;\n}\n\n* {\n  margin: 0;\n  padding: 0;\n  box-sizing: border-box;\n  transition: background-color ease-out 120ms;\n}\n\nhtml {\n  font-size: 62.5%;\n}\n\nbody {\n  font-size: 1.6rem;\n  font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;\n  background-color: var(--white);\n  height: 100vh;\n}\n\nbody {\n  display: grid;\n  grid-template-rows: calc(var(--nav-height) + 1rem) 1fr;\n}\n\n.nav-container {\n  grid-row: 1 / 2;\n}\n\n.form-container {\n  grid-row: 2 / 3;\n}\n\n\n.nav-container {\n  position: fixed;\n  top: 0;\n  right: 0;\n  left: 0;\n  background-color: var(--gray);\n  height: var(--nav-height);\n  padding: 0 2rem;\n  box-shadow: 0 0.1rem 0 0 var(--dark-gray);\n}\n\n.nav-content {\n  display: grid;\n  grid-template-columns: 1fr 5fr;\n  min-height: 100%;\n\n}\n\n.nav-content li {\n  background-color: var(--gray);\n  list-style: none;\n  display: flex;\n  align-items: center;\n}\n\n.nav-content a {\n  color: var(--darker);\n  text-decoration: none;\n  font-size: 2rem;\n  font-weight: bold;\n  padding: calc((var(--nav-height) - 2.3rem) /2);\n}\n\n.nav-content a:hover {\n  background-color: var(--dark-gray);\n}\n\n.nav-content .left,\n.nav-content .right {\n  height: var(--nav-height);\n  display: flex;\n  align-items: stretch;\n  justify-content: center;\n}\n\n.nav-content .left {\n  grid-column: 1 / 2;\n  display: flex;\n  justify-content: left;\n}\n\n.nav-content .right {\n  grid-column: 2 / 3;\n  display: flex;\n  justify-content: right;\n}\n\n.form-container {\n  border: none;\n  /* height: 100%; */\n  display: flex;\n  justify-content: center;\n  align-items: center;\n}\n\n.form-content {\n  width: 50vw;\n  max-width: 30rem;\n  display: flex;\n  flex-wrap: wrap;\n  justify-content: center;\n  padding: 1rem;\n  gap: 1.5rem;\n  border: 0.2rem solid var(--blue);\n  border-radius: 1rem;\n  box-shadow: 0 0 0.5rem 0.05rem var(--darker);\n}\n\n\n\n.form-item {\n  display: block;\n  width: 100%;\n}\n\n.form-item label {\n  display: block;\n  padding-bottom: 0.5rem;\n}\n\n.form-item input,\n.form-item button {\n  width: 100%;\n  height: 3rem;\n  text-align: center;\n}\n\n.form-item input {\n  border: 0.1rem solid var(--gray);\n}\n\n.form-item input:hover {\n  border: 0.1rem solid var(--dark);\n}\n\n.form-item input:focus {\n  border: 0.rem solid var(--darker);\n}\n\n.form-item button {\n  background-color: var(--blue);\n  border: none;\n  border-radius: 0.5rem;\n  font-weight: 500;\n  font-size: 1.8rem;\n\n}\n\n.form-item button:hover {\n  background-color: var(--green);\n}\n\n.invalid-input {\n  color: var(--darker);\n  background-color: var(--red);\n  border-radius: 0 0 0.8rem 0.8rem;\n  font-size: 1.2rem;\n  padding: 0.5rem;\n  text-align: center;\n}"],"sourceRoot":""}]);
// Exports
...
/* harmony import */ var _modules_UserValidation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/UserValidation */ "./frontend/modules/UserValidation.js");
...
if (document.querySelector('.login-form')) (0,_modules_UserValidation__WEBPACK_IMPORTED_MODULE_3__["default"])('.login-form');
if (document.querySelector('.register-form')) (0,_modules_UserValidation__WEBPACK_IMPORTED_MODULE_3__["default"])('.register-form');
})();
